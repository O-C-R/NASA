...
void setupHexColors() {
  ...
  hexColors.put("moon", #F7C815);//#FFB914);
  hexColors.put("people", #f5a3cf);
  hexColors.put("research_and_development", #B6E0E2);//#BDEEFF);
  hexColors.put("rockets", #F8F3D6);//#FFDFA8);
  hexColors.put("russia", #EC1228);//#E50C30);
  hexColors.put("satellites", #F94411);//#FF450D);
  hexColors.put("space_shuttle", #FE8012);//#FF7E0D);
