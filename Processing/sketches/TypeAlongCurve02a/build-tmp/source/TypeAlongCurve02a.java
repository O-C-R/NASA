...
public class TypeAlongCurve02a extends PApplet {
...
public void setupHexColors() {
  ...
  hexColors.put("administrative", 0xff66ffff);
  hexColors.put("astronaut", 0xffff331f);
  hexColors.put("mars", 0xffcc1166);
  hexColors.put("moon", 0xff5EA2B0);
  hexColors.put("people", 0xffE0D9C4);
  hexColors.put("research_and_development", 0xffE0AE7A);
  hexColors.put("rockets", 0xffE76B36);
  hexColors.put("russia", 0xffE15D6D);
  hexColors.put("satellites", 0xff2266aa);
  hexColors.put("space_shuttle", 0xffaaf045);
  hexColors.put("spacecraft", 0xff333333);
  hexColors.put("us", 0xff0022ff);
} // end setupHexColors
...
//
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "TypeAlongCurve02a" };
    if (passedArgs != null) {
